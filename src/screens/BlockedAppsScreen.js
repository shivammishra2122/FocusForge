...
const styles = StyleSheet.create({
  ...
  permCard: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', borderRadius: 24, padding: 16, marginBottom: 16, borderWidth: 1, overflow: 'hidden' },
  ...
  warningCard: { flexDirection: 'row', gap: 12, backgroundColor: Colors.bgElevated, borderRadius: 24, padding: 14, marginBottom: 16, borderWidth: 1, borderColor: Colors.border, overflow: 'hidden' },
  ...
  appList: { backgroundColor: Colors.bgCard, borderRadius: 24, borderWidth: 1, borderColor: Colors.border, overflow: 'hidden', marginBottom: 20 },
