...
const styles = StyleSheet.create({
  ...
  levelBanner: { marginHorizontal: 24, borderRadius: 24, padding: 20, flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginBottom: 16, overflow: 'hidden' },
  ...
  progressCard: { marginHorizontal: 24, backgroundColor: Colors.bgCard, borderRadius: 24, padding: 16, borderWidth: 1, borderColor: Colors.border, marginBottom: 20, overflow: 'hidden' },
  ...
  card: { backgroundColor: Colors.bgCard, borderRadius: 24, padding: 18, flexDirection: 'row', gap: 14, borderWidth: 1, borderColor: Colors.border, overflow: 'hidden', alignItems: 'center' },
