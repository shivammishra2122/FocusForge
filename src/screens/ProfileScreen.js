...
const styles = StyleSheet.create({
  ...
  statsRow: { flexDirection: 'row', alignItems: 'center', backgroundColor: Colors.bgCard, borderRadius: 18, marginBottom: 20, borderWidth: 1, borderColor: Colors.border, overflow: 'hidden' },
  ...
  quoteCard: { flexDirection: 'row', gap: 14, backgroundColor: Colors.bgCard, borderRadius: 18, padding: 20, marginBottom: 28, borderWidth: 1, borderColor: Colors.border },
  ...
  section: { backgroundColor: Colors.bgCard, borderRadius: 18, borderWidth: 1, borderColor: Colors.border, marginBottom: 28, overflow: 'hidden' },
  ...
  resetBtn: { backgroundColor: Colors.dangerSubtle, borderRadius: 16, paddingVertical: 16, alignItems: 'center', borderWidth: 1, borderColor: 'rgba(239,68,68,0.3)', marginBottom: 28 },
